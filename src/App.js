  ...
  return (
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          <Route path='*' element={<ListItems   setHomeMsgFlag={setHomeMsgFlag} msgFlag={msgFlag} setMsgFlag={setMsgFlag} listArr={listArr} addToCarArr={addToCarArr} addToTatal={addToTatal} calaTotalArr={calaTotalArr} />} />
          <Route path='/cart' element={<CartItems homeMsg={homeMsg} cartArr={cartArr} sum={sum} buy={buy} />} />
        </Routes>
      </BrowserRouter>
    </div>
  );
